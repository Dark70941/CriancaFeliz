...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/11/2025 às 00:44
...
CREATE TABLE `atendido` (
  ...
  `cad_unico` varchar(100) DEFAULT NULL,
...
INSERT INTO `atendido` (`idatendido`, `status`, `data_cadastro`, `nome`, `data_nascimento`, `faixa_etaria`, `cpf`, `rg`, `endereco`, `numero`, `complemento`, `bairro`, `cidade`, `estado`, `cep`, `telefone`, `email`, `foto`, `id_responsavel`, `data_acolhimento`, `encaminha_por`, `queixa_principal`, `escola`, `periodo`, `ponto_referencia`, `cras`, `ubs`, `cad_unico`, `acolhimento_responsavel`, `acolhimento_funcao`, `carimbo`) VALUES
(1, 'Ativo', '2025-10-18', 'Ana Beatriz Silva', '2012-05-14', '12-14', '111.222.333-44', 'MG-12.345.678', 'Rua das Flores, 123 - Centro', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Ativo', '2025-10-18', 'Carlos Eduardo Santos', '2010-09-02', '15-17', NULL, NULL, 'Av. Brasil, 456 - Bairro Alto', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'Ativo', '2025-11-16', 'ab', '2016-01-28', '9', '34197836040', '111111111', 'a', '483', '', 'Éden', 'a', NULL, '18103021', '11111111111', NULL, NULL, 11, '2025-01-28', '', 'a', '', '', '', '', '', '', '', '', NULL);
...
(12, 1, '2025-11-16', 'P', NULL, NULL, 1, '2025-11-16 21:30:59', '2025-11-16 21:30:59'),
(13, 2, '2025-11-16', 'F', '', NULL, 1, '2025-11-16 21:31:00', '2025-11-16 21:31:00');
...
(5, 1, 1, '2025-11-12', 'F', '', NULL, 1, '2025-11-16 21:31:31', '2025-11-16 21:31:31'),
(6, 2, 1, '2025-11-12', 'P', NULL, NULL, 1, '2025-11-16 21:31:35', '2025-11-16 21:31:35');
...
(11, 'a', '35572905062', '111111111', '11111111111', NULL, 'pai', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `atendido`
  MODIFY `idatendido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `frequencia_dia`
  MODIFY `id_frequencia_dia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de tabela `frequencia_oficina`
--
ALTER TABLE `frequencia_oficina`
  MODIFY `id_frequencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `responsavel`
  MODIFY `idresponsavel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
