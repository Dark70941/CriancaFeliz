-- =====================================================
-- ADICIONAR CAMPOS FALTANTES AOS LOGS
-- =====================================================

-- Adicionar coluna para armazenar dados completos em JSON se não existir
ALTER TABLE `log`
ADD COLUMN IF NOT EXISTS `dados_completos` LONGTEXT DEFAULT NULL COMMENT 'Dados completos em JSON';

-- Criar índice para melhor performance
CREATE INDEX IF NOT EXISTS `idx_dados_completos` ON `log` (`dados_completos`(100));

-- =====================================================
-- ATUALIZAR TRIGGERS PARA INCLUIR DADOS COMPLETOS
-- =====================================================
...
-- =====================================================
-- NOVO TRIGGER INSERT COM TODOS OS DADOS
-- =====================================================
...
-- =====================================================
-- NOVO TRIGGER UPDATE COM TODOS OS DADOS
-- =====================================================
...
INSERT INTO `log` (
    ...
    @ip_usuario,
    JSON_OBJECT(
        'renda_familiar_anterior', OLD.renda_familiar,
        'renda_familiar_novo', NEW.renda_familiar,
        'numero_comodos_anterior', OLD.numero_comodos,
        'numero_comodos_novo', NEW.numero_comodos,
        'qtd_pessoas_anterior', OLD.qtd_pessoas,
        'qtd_pessoas_novo', NEW.qtd_pessoas
    )
);

-- =====================================================
-- NOVO TRIGGER DELETE COM TODOS OS DADOS
-- =====================================================
